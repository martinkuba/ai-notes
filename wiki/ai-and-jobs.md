---
tags: [jobs, economics, labor, displacement]
---

# AI and Jobs

The impact of AI on employment, workforce composition, and the nature of work itself. One of the most heavily covered themes in the sources, with a wide range of views from catastrophic displacement to nuanced augmentation.
...
- **Task expansion** — AI makes new tasks possible, expanding workload
- **Blurred boundaries** — Always-on AI removes natural stopping points
- **Multitasking pressure** — AI enables parallel work streams, increasing cognitive load
