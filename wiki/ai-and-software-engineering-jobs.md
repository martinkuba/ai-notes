---
tags: [jobs, coding, software-engineering, displacement]
---
...
- Standard implementations from well-defined specs
- Bug fixes for common patterns
- Test generation
- Code review for style/convention

### What Remains
- System design and architecture decisions
- Understanding user needs and translating to requirements
- Judgment about trade-offs (performance vs. maintainability, etc.)
