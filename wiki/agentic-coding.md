...
- **[Claude Code](claude-code.md)** — Anthropic's terminal-based agentic coding tool. Follows an explore-plan-code-commit workflow. Customizable via CLAUDE.md files, [MCP](mcp.md) servers, and slash commands.
