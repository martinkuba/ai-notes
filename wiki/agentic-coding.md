...
### Vibe Coding
An intuitive, conversational style of coding with AI — describing what you want rather than specifying how. Works best when combined with [Spec Driven Development](spec-driven-development.md) to prevent chaos. See sources: [How I Learned To Stop Worrying And Love Vibe Coding](../summaries/how-i-learned-to-stop-worrying-and-love-vibe-coding.md), [Vibe Specs Vibe Coding That Actually Works](../summaries/vibe-specs-vibe-coding-that-actually-works.md)
